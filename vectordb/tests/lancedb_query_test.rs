...
mod test_lancedb_query {
    ...
    use configs::constants::CHAT_API_KEY;
    use configs::constants::CHAT_API_URL;
    ...
    use vectordb::query;
    use vectordb::query::get_content_from_stream;
    ...
    async fn query_content_based_on_metadata_test() {
        ...
        let table_name = "test_table_query_content_metadata";
    ...
    async fn get_content_from_stream_test() {
        ...
        let table_name = "test_table_stream";
        create_test_embedding_table(TEST_DB_URI, table_name)
            .await
            .expect("Failed to create test embedding table");
    ...
    async fn query_vector_table_test() {
        ...
        let table_name = "test_table_vector";
        create_test_embedding_table(TEST_DB_URI, table_name)
            .await
            .expect("Failed to create test embedding table");
